...
async def parse_cmd():
    ...
    parser.add_argument('--platform', type=str, help='Media platform select (xhs | douyin | ks | bili | weibo | tieba | zhihu)',
                        choices=["xhs", "douyin", "ks", "bili", "weibo", "tieba", "zhihu"], default=config.PLATFORM)
